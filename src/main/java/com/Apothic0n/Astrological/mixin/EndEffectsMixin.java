...
@Mixin(value = DimensionSpecialEffects.EndEffects.class, priority = 69420)
@Implements(@Interface(iface = IDimensionSpecialEffectsExtension.class, prefix = "astrological$"))
public class EndEffectsMixin implements IDimensionSpecialEffectsExtension {
