...
public class OchreSeleniteBlockItem extends BlockItem {
    ...
    public void appendHoverText(ItemStack itemStack, @Nullable Level level, List<Component> text, TooltipFlag flag) {
        ...
        text.add(1, Component.translatable(Util.makeDescriptionId("item", new ResourceLocation("inversia:ochre_selenite"))).withStyle(ChatFormatting.YELLOW).withStyle(ChatFormatting.ITALIC));
    }
}
