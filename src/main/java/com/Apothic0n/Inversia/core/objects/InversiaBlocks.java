...
public final class InversiaBlocks {
    ...
    public static final RegistryObject<Block> SLEEP = BLOCKS.register("sleep", () ->
            new MangroveRootsBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).instrument(NoteBlockInstrument.BASS).strength(0.7F).randomTicks().sound(SoundType.WOOL).noOcclusion().noOcclusion().noCollission()));
    ...
    public static final RegistryObject<Block> SLEEP_VENT = BLOCKS.register("sleep_vent", () ->
            new SleepVentBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_YELLOW).randomTicks().instrument(NoteBlockInstrument.BASEDRUM).sound(SoundType.STONE).strength(1.5F, 3.0F)));

    public static final RegistryObject<Block> SLEEP_FIRE = BLOCKS.register("sleep_fire", () ->
            new SleepFireBlock(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_PURPLE).replaceable().noCollission().instabreak().lightLevel((p_152607_) -> {return 1;}).sound(SoundType.WOOL).pushReaction(PushReaction.DESTROY)));
