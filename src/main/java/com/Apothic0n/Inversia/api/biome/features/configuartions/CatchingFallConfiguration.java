package com.Apothic0n.Inversia.api.biome.features.configuartions;
...
public class CatchingFallConfiguration implements FeatureConfiguration {
    public static final Codec<CatchingFallConfiguration> CODEC = RecordCodecBuilder.create((fields) -> {
        return fields.group(FluidState.CODEC.fieldOf("state").forGetter((v) -> {
            ...
            return v.holeCount;
        }), Registry.BLOCK.byNameCodec().listOf().fieldOf("valid_blocks").xmap(ImmutableSet::copyOf, ImmutableList::copyOf).forGetter((v) -> {
            return (ImmutableSet<Block>)v.validBlocks;
        }), Registry.BLOCK.byNameCodec().listOf().fieldOf("invalid_blocks").xmap(ImmutableSet::copyOf, ImmutableList::copyOf).forGetter((v) -> {
            return (ImmutableSet<Block>) v.validBlocks;
        }), BlockState.CODEC.fieldOf("basinMaterial").forGetter((v) -> {
            return v.basinMaterial;
        }), BlockState.CODEC.fieldOf("basinMaterial2").forGetter((v) -> {
    ...
    public final BlockState basinMaterial;
    public final BlockState basinMaterial2;

    public CatchingFallConfiguration(FluidState fluidState, boolean requiresBlockBelow, int rockCount, int holeCount, Set<Block> validBlocks, Set<Block> invalidBlocks, BlockState basinMaterial, BlockState basinMaterial2) {
