...
public class LargeCalcitePillarFeature extends Feature<LargeDripstoneConfiguration> {
    ...
    private static LargeCalcitePillarFeature.LargePillar makeCalcite(BlockPos pRoot, boolean pPointingUp, Random pRandom, int pRadius, FloatProvider pBluntnessBase, FloatProvider pScaleBase) {
    ...
    static final class LargePillar {
        ...
        void placeBlocks(WorldGenLevel pLevel, Random pRandom, LargeCalcitePillarFeature.WindOffsetter pWindOffsetter) {
