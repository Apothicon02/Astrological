...
public class LargePackedIcePillarFeature extends Feature<LargeDripstoneConfiguration> {
    ...
    private static LargePackedIcePillarFeature.LargePillar makeIce(BlockPos pRoot, boolean pPointingUp, Random pRandom, int pRadius, FloatProvider pBluntnessBase, FloatProvider pScaleBase) {
    ...
    static final class LargePillar {
        ...
        void placeBlocks(WorldGenLevel pLevel, Random pRandom, LargePackedIcePillarFeature.WindOffsetter pWindOffsetter, int pRadius) {
