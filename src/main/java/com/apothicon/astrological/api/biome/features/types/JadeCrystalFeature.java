...
public class JadeCrystalFeature extends Feature<SimpleBlockConfiguration> {
    public JadeCrystalFeature(Codec<SimpleBlockConfiguration> pContext) {
        super(pContext);
    }

    public static List<List<Block>> lootBlocks = List.of(
            List.of(Blocks.LAVA),
            List.of(Blocks.LAVA, Blocks.VERDANT_FROGLIGHT),
            List.of(Blocks.LAVA, Blocks.VERDANT_FROGLIGHT, AstrologicalBlocks.VERDANT_SELENITE.get()));
    ...
    public boolean place(FeaturePlaceContext<SimpleBlockConfiguration> pContext) {
        ...
        if (randomNumber < 2) {
            ...
            positions.add(checkBlockPos(worldGenLevel, blockPos));
            positions.add(checkBlockPos(worldGenLevel, blockPos.above()));
            positions.add(checkBlockPos(worldGenLevel, blockPos.above(2)));
            positions.addAll(generateSmallCircle(worldGenLevel, blockPos.above(3)));
            ...
            positions.addAll(generateSmallCircle(worldGenLevel, blockPos.above(9)));
            positions.add(checkBlockPos(worldGenLevel, blockPos.above(10)));
            positions.add(checkBlockPos(worldGenLevel, blockPos.above(11)));
            positions.add(checkBlockPos(worldGenLevel, blockPos.above(12)));
        }
        ...
        if (randomNumber2 < 2) {
            ...
            positions.add(checkBlockPos(worldGenLevel, newBlockPos));
            positions.add(checkBlockPos(worldGenLevel, newBlockPos.above()));
            positions.addAll(generateSmallCircle(worldGenLevel, newBlockPos.above(2)));
            positions.addAll(generateSmallCircle(worldGenLevel, newBlockPos.above(3)));
            ...
            positions.addAll(generateSmallCircle(worldGenLevel, newBlockPos.above(10)));
            positions.add(checkBlockPos(worldGenLevel, newBlockPos.above(11)));
            ...
            positions.add(checkBlockPos(worldGenLevel, newBlockPos));
            positions.add(checkBlockPos(worldGenLevel, newBlockPos.above()));
            positions.add(checkBlockPos(worldGenLevel, newBlockPos.above(2)));
            positions.addAll(generateSmallCircle(worldGenLevel, newBlockPos.above(3)));
            ...
            positions.addAll(generateSmallCircle(worldGenLevel, newBlockPos.above(9)));
            positions.add(checkBlockPos(worldGenLevel, newBlockPos.above(10)));
            positions.add(checkBlockPos(worldGenLevel, newBlockPos.above(11)));
            positions.add(checkBlockPos(worldGenLevel, newBlockPos.above(12)));
        }
    ...
    private BlockPos checkBlockPos(WorldGenLevel worldGenLevel, BlockPos blockPos) {
        if (worldGenLevel.getBlockState(blockPos).getBlock().equals(Blocks.PURPUR_BLOCK)) {
