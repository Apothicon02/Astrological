        ...
        if (level != null) {
            ...
            if (AstrologicalJsonReader.customEndSky) {
                ...
                for (int i = 0; i < 6; ++i) {
                    ...
                    bufferbuilder.addVertex(matrix4f, -110.0F, -110.0F, 110.0F).setUv(0.0F, 4).setColor(0, 0, 0, 100);
                    bufferbuilder.addVertex(matrix4f, 110.0F, -110.0F, 110.0F).setUv(4, 4).setColor(0, 0, 0, 100);
                    bufferbuilder.addVertex(matrix4f, 110.0F, -110.0F, -110.0F).setUv(4, 0.0F).setColor(0, 0, 0, 100);
